...
,{"id":3,"srcImagen":"../img/comunismo.jpg","titulo":"FRIENDS version rusa","autor":"La URS","duracion":"0:43 min","srcVideo":"../video/videoplayback.mp4"},{"id":4,"srcImagen":"../img/yoda.jpg","titulo":"Mi moto hace Brrr","autor":"La Fuerza","duracion":"0:18 min","srcVideo":"../video/yoda.mp4"}]`;
...
function subtitulos(){
    if(DOM.select.value=="español"){
        DOM.video.textTracks[1].mode = "hidden";
        DOM.video.textTracks[0].mode = "showing";
    }
    if(DOM.select.value=="ingles"){
        DOM.video.textTracks[0].mode = "hidden";
        DOM.video.textTracks[1].mode = "showing";
    }
}
